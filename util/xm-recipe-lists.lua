...
xm_terrain_recipes = {
	...
	{"clay-b", "__xander-mod-th__/graphics/recipe/raw/bauxite-clay.png", "sluice", {primary = {r = 0.48, g = 0.34, b = 0.24}, secondary = {r = 0.5, g = 0.5, b = 0.5}, tertiary = {r = 0.75, g = 0.75, b = 0.75}}, 4, false, {{"milled-bauxite", 2}, {type = "fluid", name = "water", amount = 10}}, {{"clay", 10}, {type = "fluid", name = "gray-water", amount = 10}}, "terrain"},
...
xm_concentrate_recipes = {
	{"chalcocite", "__xander-mod-th__/graphics/recipe/raw/chalcocite-washing.png", "sluice", {primary = {r = 0.48, g = 0.34, b = 0.24}, secondary = {r = 0.5, g = 0.5, b = 0.5}, tertiary = {r = 0.75, g = 0.75, b = 0.75}}, 20, false, {{"milled-copper-ore", 10}, {type = "fluid", name = "water", amount = 50}}, {{"chalcocite", 10}, {"gravel", 2}, {type = "fluid", name = "gray-water", amount = 50}}, "concentrate"},
	{"molybdenite", "__xander-mod-th__/graphics/recipe/raw/chalcocite-washing.png", "sluice", {primary = {r = 0.48, g = 0.34, b = 0.24}, secondary = {r = 0.5, g = 0.5, b = 0.5}, tertiary = {r = 0.75, g = 0.75, b = 0.75}}, 40, false, {{"milled-copper-ore", 10}, {type = "fluid", name = "water", amount = 50}}, {{"molybdenite", 5}, {"gravel", 2}, {type = "fluid", name = "gray-water", amount = 50}}, "concentrate"},
	{"saltpeter", "__xander-mod-th__/graphics/recipe/salt/water-saltpeter.png", "sluice", {primary = {r = 0.48, g = 0.34, b = 0.24}, secondary = {r = 0.5, g = 0.5, b = 0.5}, tertiary = {r = 0.75, g = 0.75, b = 0.75}}, 4, false, {{"evaporites", 10}, {type = "fluid", name = "water", amount = 50}, {"sodium-carbonate", 1}}, {{"saltpeter", 5}, {type = "fluid", name = "gray-water", amount = 50}}, "concentrate"},
	{"borax", "__xander-mod-th__/graphics/recipe/raw/borax-evaporation.png", "refining", {primary = {r = 0.48, g = 0.34, b = 0.24}, secondary = {r = 0.5, g = 0.5, b = 0.5}, tertiary = {r = 0.75, g = 0.75, b = 0.75}}, 40, false, {{"evaporites", 20}, {type = "fluid", name = "water", amount = 50}}, {{"borax", 1}, {type = "fluid", name = "distilled-water", amount = 50}}, "concentrate"},
	{"lithium-concentrate", "__xander-mod-th__/graphics/recipe/raw/lithium-precipitation.png", "chemistry", {primary = {r = 0.48, g = 0.34, b = 0.24}, secondary = {r = 0.5, g = 0.5, b = 0.5}, tertiary = {r = 0.75, g = 0.75, b = 0.75}}, 10, false, {{"evaporites", 10}, {type = "fluid", name = "water", amount = 100}, {"calcium-oxide", 1}}, {{"lithium-concentrate", 2}, {"calcium-chloride", 1}, {type = "fluid", name = "gray-water", amount = 50}}, "concentrate"},
	{"chalcopyrite", "__xander-mod-th__/graphics/recipe/raw/chalcopyrite-washing.png", "sluice", {primary = {r = 0.48, g = 0.34, b = 0.24}, secondary = {r = 0.5, g = 0.5, b = 0.5}, tertiary = {r = 0.75, g = 0.75, b = 0.75}}, 20, false, {{"milled-igneous-sulfide", 10}, {type = "fluid", name = "water", amount = 50}}, {{"chalcopyrite", 10}, {"gravel", 2}, {type = "fluid", name = "gray-water", amount = 50}}, "concentrate"},
	{"pentlandite", "__xander-mod-th__/graphics/recipe/raw/nickel-oxide.png", "sluice", {primary = {r = 0.48, g = 0.34, b = 0.24}, secondary = {r = 0.5, g = 0.5, b = 0.5}, tertiary = {r = 0.75, g = 0.75, b = 0.75}}, 20, false, {{"milled-nickeliferous-laterite", 10}, {type = "fluid", name = "water", amount = 50}}, {{"nickel-oxide", 10}, {"gravel", 2}, {type = "fluid", name = "gray-water", amount = 50}}, "concentrate"},
	{"hematite", "__xander-mod-th__/graphics/recipe/raw/hematite-washing.png", "sluice", {primary = {r = 0.48, g = 0.34, b = 0.24}, secondary = {r = 0.5, g = 0.5, b = 0.5}, tertiary = {r = 0.75, g = 0.75, b = 0.75}}, 20, false, {{"milled-iron-ore", 10}, {type = "fluid", name = "water", amount = 50}}, {{"hematite", 10}, {"gravel", 2}, {type = "fluid", name = "gray-water", amount = 50}}, "concentrate"},
	{"pyrolusite", "__xander-mod-th__/graphics/recipe/raw/hematite-washing.png", "sluice", {primary = {r = 0.48, g = 0.34, b = 0.24}, secondary = {r = 0.5, g = 0.5, b = 0.5}, tertiary = {r = 0.75, g = 0.75, b = 0.75}}, 20, false, {{"milled-iron-ore", 10}, {type = "fluid", name = "water", amount = 50}}, {{"pyrolusite", 10}, {"gravel", 2}, {type = "fluid", name = "gray-water", amount = 50}}, "concentrate"},
	{"magnetite", "__xander-mod-th__/graphics/recipe/raw/vanadium-magnetite.png", "sluice", {primary = {r = 0.48, g = 0.34, b = 0.24}, secondary = {r = 0.5, g = 0.5, b = 0.5}, tertiary = {r = 0.75, g = 0.75, b = 0.75}}, 20, false, {{"milled-magnetic", 10}}, {{"magnetite", 10}, {"gravel", 2}}, "concentrate"},
	{"chromite", "__xander-mod-th__/graphics/recipe/raw/chromite-flotation.png", "sluice", {primary = {r = 0.48, g = 0.34, b = 0.24}, secondary = {r = 0.5, g = 0.5, b = 0.5}, tertiary = {r = 0.75, g = 0.75, b = 0.75}}, 40, false, {{"sand", 10}, {type = "fluid", name = "water", amount = 50}, {"surfactant", 1}}, {{"chromite", 10}, {"quartz-sand", 2}, {type = "fluid", name = "waste-water", amount = 50}}, "concentrate"},
	{"sphalerite", "__xander-mod-th__/graphics/recipe/raw/sphalerite-flotation.png", "sluice", {primary = {r = 0.48, g = 0.34, b = 0.24}, secondary = {r = 0.5, g = 0.5, b = 0.5}, tertiary = {r = 0.75, g = 0.75, b = 0.75}}, 40, false, {{"milled-massive-sulfide", 10}, {type = "fluid", name = "water", amount = 50}, {"surfactant", 1}}, {{"sphalerite", 5}, {"gravel", 2}, {type = "fluid", name = "waste-water", amount = 50}}, "concentrate"},
	{"galena", "__xander-mod-th__/graphics/recipe/raw/galena-washing.png", "sluice", {primary = {r = 0.48, g = 0.34, b = 0.24}, secondary = {r = 0.5, g = 0.5, b = 0.5}, tertiary = {r = 0.75, g = 0.75, b = 0.75}}, 20, false, {{"milled-massive-sulfide", 10}, {type = "fluid", name = "water", amount = 50}}, {{"galena", 10}, {"gravel", 2}, {type = "fluid", name = "gray-water", amount = 50}}, "concentrate"},
	{"hydroxylapatite", "__xander-mod-th__/graphics/recipe/raw/phosphate-flotation.png", "sluice", {primary = {r = 0.48, g = 0.34, b = 0.24}, secondary = {r = 0.5, g = 0.5, b = 0.5}, tertiary = {r = 0.75, g = 0.75, b = 0.75}}, 40, false, {{"phosphorite", 10}, {type = "fluid", name = "water", amount = 50}, {"surfactant", 1}}, {{"hydroxylapatite", 10}, {"gravel", 2}, {type = "fluid", name = "waste-water", amount = 50}}, "concentrate"},
	{"fluorite", "__xander-mod-th__/graphics/recipe/raw/fluorite-flotation.png", "sluice", {primary = {r = 0.48, g = 0.34, b = 0.24}, secondary = {r = 0.5, g = 0.5, b = 0.5}, tertiary = {r = 0.75, g = 0.75, b = 0.75}}, 40, false, {{"phosphorite", 10}, {type = "fluid", name = "water", amount = 50}, {"surfactant", 1}}, {{"fluorite", 10}, {"gravel", 2}, {type = "fluid", name = "waste-water", amount = 50}}, "concentrate"},
	{"ilmenite", "__xander-mod-th__/graphics/recipe/raw/rutile-flotation.png", "sluice", {primary = {r = 0.48, g = 0.34, b = 0.24}, secondary = {r = 0.5, g = 0.5, b = 0.5}, tertiary = {r = 0.75, g = 0.75, b = 0.75}}, 40, false, {{"sand", 10}, {type = "fluid", name = "water", amount = 50}, {"surfactant", 1}}, {{"ilmenite", 10}, {"quartz-sand", 2}, {type = "fluid", name = "waste-water", amount = 50}}, "concentrate"},
	{"zircon", "__xander-mod-th__/graphics/recipe/raw/zirconia-flotation.png", "sluice", {primary = {r = 0.48, g = 0.34, b = 0.24}, secondary = {r = 0.5, g = 0.5, b = 0.5}, tertiary = {r = 0.75, g = 0.75, b = 0.75}}, 40, false, {{"sand", 10}, {type = "fluid", name = "water", amount = 50}, {"surfactant", 1}}, {{"zircon", 2}, {"quartz-sand", 2}, {type = "fluid", name = "waste-water", amount = 50}}, "concentrate"},
	{"cassiterite", "__xander-mod-th__/graphics/recipe/raw/cassiterite-washing.png", "sluice", {primary = {r = 0.48, g = 0.34, b = 0.24}, secondary = {r = 0.5, g = 0.5, b = 0.5}, tertiary = {r = 0.75, g = 0.75, b = 0.75}}, 20, false, {{"milled-skarn", 10}, {type = "fluid", name = "water", amount = 50}}, {{"cassiterite", 10}, {"quartz-sand", 2}, {type = "fluid", name = "gray-water", amount = 50}}, "concentrate"},
	{"scheelite", "__xander-mod-th__/graphics/recipe/raw/scheelite-flotation.png", "sluice", {primary = {r = 0.48, g = 0.34, b = 0.24}, secondary = {r = 0.5, g = 0.5, b = 0.5}, tertiary = {r = 0.75, g = 0.75, b = 0.75}}, 40, false, {{"milled-skarn", 10}, {type = "fluid", name = "water", amount = 50}, {"surfactant", 1}}, {{"scheelite", 2}, {"quartz-sand", 2}, {type = "fluid", name = "waste-water", amount = 50}}, "concentrate"},
	{"monazite", "__xander-mod-th__/graphics/recipe/raw/monazite-flotation.png", "sluice", {primary = {r = 0.48, g = 0.34, b = 0.24}, secondary = {r = 0.5, g = 0.5, b = 0.5}, tertiary = {r = 0.75, g = 0.75, b = 0.75}}, 40, false, {{"milled-uranium-ore", 10}, {type = "fluid", name = "water", amount = 50}, {"surfactant", 1}}, {{"monazite", 5}, {"gravel", 2}, {type = "fluid", name = "waste-water", amount = 50}}, "concentrate"},
	{"pitchblende", "__xander-mod-th__/graphics/recipe/raw/monazite-flotation.png", "sluice", {primary = {r = 0.48, g = 0.34, b = 0.24}, secondary = {r = 0.5, g = 0.5, b = 0.5}, tertiary = {r = 0.75, g = 0.75, b = 0.75}}, 20, false, {{"milled-uranium-ore", 10}, {type = "fluid", name = "water", amount = 50}}, {{"pitchblende", 5}, {"gravel", 2}, {type = "fluid", name = "gray-water", amount = 50}}, "concentrate"},
...
do
	...
	local icons = {"__xander-mod-th__/graphics/recipe/refining/hall-heroult.png", "__xander-mod-th__/graphics/recipe/refining/chromium-reduction.png", "__xander-mod-th__/graphics/recipe/refining/cobalt-electrowinning.png", "__xander-mod-th__/graphics/recipe/refining/miller-process.png", nil, "__xander-mod-th__/graphics/recipe/refining/magnesium-electrolysis.png", nil, "__xander-mod-th__/graphics/recipe/refining/platinum-smelting.png", "__xander-mod-th__/graphics/recipe/refining/re-reduction.png", "__xander-mod-th__/graphics/recipe/refining/silver-electrowinning.png", nil, nil, "__xander-mod-th__/graphics/recipe/refining/acheson-silicon.png", nil, "__xander-mod-th__/graphics/recipe/refining/titanium-remelting.png", nil, "__xander-mod-th__/graphics/recipe/refining/238-reduction.png", "__xander-mod-th__/graphics/recipe/refining/weapons-reduction.png", "__xander-mod-th__/graphics/recipe/refining/vanadium-reduction.png", "__xander-mod-th__/graphics/recipe/refining/zinc-electrowinning.png"}
...
do
	...
	local ingredients = {{{"mechanism-0", 1}, {"pipe-copper", 2}, {"forging-iron", 1}}, {{"mechanism-1", 1}, {"pipe-copper", 2}, {"forging-iron", 1}}, {{"forging-iron", 1}, {"pipe-steel", 2}}, {{"forging-iron", 1}, {"shaft-0", 1}, {"iron-gear-wheel", 2}, {"bronze-plate", 2}},
		...
		{{"battery-3", 1}, {"control-3", 1}, {"forging-titanium", 2}, {"motor-3", 2}, {"carbon-fiber", 1}, {type = "fluid", name = "uncured-epoxy", amount = 10}}, {{"steel-plate", 4}, {"stone-brick", 10}, {"wood", 1}},
...
do
	...
	local ingredients = {--[[{{"wood", 1}, {"forging-titanium", 5}}, {{"wood", 1}, {"bronze-plate", 4}}, {{"wood", 1}, {"iron-plate", 4}}, {{"forging-steel", 5}, {"wood", 1}},
