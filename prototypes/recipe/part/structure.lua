...
--Iron Casting from Raw Iron (C)
{
  type = "recipe",
  name = "forging-iron-c",
  icon = "__xander-mod-th__/graphics/recipe/alloy/forging-iron-c.png",
  icon_size = 32,
  category = "forge",
  energy_required = 64,
  enabled = false,
...
--Steel Forging from Raw Iron (B)
{
  ...
  icon = "__xander-mod-th__/graphics/recipe/alloy/forging-steel-b.png",
  icon_size = 32,
  category = "forge",
  energy_required = 64,
  enabled = false,
...
--Alloy Steel Forging A
{
  ...
  icon = "__xander-mod-th__/graphics/recipe/alloy/forging-alloy-a.png",
  icon_size = 32,
  category = "forge",
  energy_required = 32,
  enabled = false,
...
--Alloy Steel Forging B
{
  ...
  icon = "__xander-mod-th__/graphics/recipe/alloy/forging-alloy-b.png",
  icon_size = 32,
  category = "forge",
  energy_required = 64,
  enabled = false,
...
--Stainless Steel Forging
{
  ...
  icon = "__xander-mod-th__/graphics/recipe/alloy/forging-stainless.png",
  icon_size = 32,
  category = "forge",
  energy_required = 32,
  enabled = false,
  ...
  main_product = "forging-stainless",
  subgroup = "structure"
},
--Duralumin Casting
{
...
--Steel Gear Blank B
{
  type = "recipe",
  name = "blank-3-b",
  icon = "__xander-mod-th__/graphics/recipe/mechanical/blank-3-b.png",
  icon_size = 32,
  category = "forge",
  energy_required = 16,
  enabled = false,
