...
--Copper Pipe-To-Ground
{
	...
	icon = "__xander-mod-th__/graphics/item/logistic/pipe/pipe-to-ground-copper.png",
	icon_size = 32,
	flags = {},
...
--Steel Pipe-To-Ground
{
	...
	icon = "__xander-mod-th__/graphics/item/logistic/pipe/pipe-to-ground-steel.png",
	icon_size = 32,
	flags = {},
	subgroup = "pipe-to-ground",
	order = "2",
...
--Monel Pipe-To-Ground
{
	...
	icon = "__xander-mod-th__/graphics/item/logistic/pipe/pipe-to-ground-monel.png",
	icon_size = 32,
	flags = {},
	subgroup = "pipe-to-ground",
	order = "3",
...
--Stainless Steel Pipe-To-Ground
{
	...
	icon = "__xander-mod-th__/graphics/item/logistic/pipe/pipe-to-ground-stainless.png",
	icon_size = 32,
	flags = {},
	subgroup = "pipe-to-ground",
	order = "4",
...
--Superalloy Pipe-To-Ground
{
	...
	icon = "__xander-mod-th__/graphics/item/logistic/pipe/pipe-to-ground-superalloy.png",
	icon_size = 32,
	flags = {},
	subgroup = "pipe-to-ground",
	order = "5",
...
--Plastic Pipe-To-Ground
{
	...
	icon = "__xander-mod-th__/graphics/item/logistic/pipe/pipe-to-ground-plastic.png",
	icon_size = 32,
	flags = {},
	subgroup = "pipe-to-ground",
	order = "6",
