...
--Iron gear
data.raw.item["iron-gear-wheel"].icon = "__xander-mod-th__/graphics/item/intermediate-products/mechanical/gear-1.png"
data.raw.item["iron-gear-wheel"].subgroup = "mechanical"
data.raw.item["iron-gear-wheel"].order = "00"

--Iron stick - renamed to Iron Rod
data.raw.item["iron-stick"].icon = "__xander-mod-th__/graphics/item/intermediate-products/mechanical/rod-1.png"
