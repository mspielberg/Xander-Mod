	...
	{
		{
			...
			"__xander-mod-th-graphics-0__/graphics/entity/production/offshore-pump-1/1.png",
		},
	},
	{
		name = "offshore-pump-1",
		icon = "__xander-mod-th__/graphics/item/production/extraction-machine/offshore-pump-1.png",
		minable = {result = "offshore-pump-1"},
		max_health = 200,
		pumping_speed = 20,
	}
),
...
xmutil.clone("assembling-machine", "assembling-machine-2",
	...
	{
		name = "logging-camp",
		icon = "__xander-mod-th__/graphics/item/production/extraction-machine/logging-camp.png",
		minable = {result = "logging-camp"},
		max_health = 50,
		fluid_boxes = {
			[2] = xmutil.NIL,
		...
		animation = {
			layers = {
				{
					filename = "__xander-mod-th-graphics-0__/graphics/entity/production/logging-camp/logging-camp.png",
					priority = "high",
					width = 113,
					height = 91,
					frame_count = 33,
	...
	{
		{
			...
			"__xander-mod-th-graphics-0__/graphics/entity/production/mining-drill-3/%1%2.png",
		},
		{
			"__base__/graphics/entity/electric-mining-drill/(h?r?-?)electric-mining-drill-(.)-patch%.png",
			"__xander-mod-th-graphics-0__/graphics/entity/production/mining-drill-3/%1%2-patch.png",
		},
	},
	{
		name = "mining-drill-3",
		icon = "__xander-mod-th__/graphics/item/production/extraction-machine/mining-drill-3.png",
		minable = {result = "mining-drill-3"},
		max_health = 400,
...
xmutil.clone("mining-drill", "electric-mining-drill",
	{
		{
			"__base__/graphics/entity/electric-mining-drill/(h?r?-?)electric-mining-drill-(.)%.png",
			"__xander-mod-th-graphics-0__/graphics/entity/production/mining-drill-4/%1%2.png",
		},
		{
			"__base__/graphics/entity/electric-mining-drill/(h?r?-?)electric-mining-drill-(.)-patch%.png",
			"__xander-mod-th-graphics-0__/graphics/entity/production/mining-drill-4/%1%2-patch.png",
		},
	},
	{
		name = "mining-drill-4",
		icon = "__xander-mod-th__/graphics/item/production/extraction-machine/mining-drill-4.png",
		minable = {result = "mining-drill-4"},
		max_health = 1000,
		resource_categories = {"basic-solid", "hard-solid", "tough-solid"},
		mining_speed = 20,
		energy_source = { emissions = 0.02 },
...
xmutil.clone("mining-drill", "pumpjack",
	{
		{
			"__base__/graphics/entity/pumpjack/(.*)horsehead.png",
			"__xander-mod-th-graphics-0__/graphics/entity/production/pumpjack-2/%12-horsehead.png",
		},
	},
	{
		name = "pumpjack-2",
		icon = "__xander-mod-th__/graphics/item/production/extraction-machine/pumpjack-2.png",
		minable = {result = "pumpjack-2"},
		max_health = 400,
	...
	{
		{
			...
			"__xander-mod-th-graphics-0__/graphics/entity/production/ore-processor-0/0.png",
		},
		{
			"__base__/graphics/entity/chemical-plant/hr-chemical-plant.png",
			"__xander-mod-th-graphics-0__/graphics/entity/production/ore-processor-0/hr-0.png",
		},
	},
	{
		name = "ore-processor-0",
		icon = "__xander-mod-th__/graphics/item/production/extraction-machine/ore-processor-0.png",
		minable = {result = "ore-processor-0"},
		max_health = 100,
		module_specification = xmutil.NIL,
		crafting_speed = 0.5,
		energy_source = {
...
xmutil.clone("assembling-machine", "chemical-plant",
	{
		{
			"__base__/graphics/entity/chemical-plant/chemical-plant.png",
			"__xander-mod-th-graphics-0__/graphics/entity/production/ore-processor-1/1.png",
		},
		{
			"__base__/graphics/entity/chemical-plant/hr-chemical-plant.png",
			"__xander-mod-th-graphics-0__/graphics/entity/production/ore-processor-1/hr-1.png",
		},
	},
	{
		name = "ore-processor-1",
		icon = "__xander-mod-th__/graphics/item/production/extraction-machine/ore-processor-1.png",
		minable = {result = "ore-processor-1"},
		max_health = 200,
	...
	{
		{
			...
			"__xander-mod-th-graphics-0__/graphics/entity/production/ore-processor-2/2.png",
		},
		{
			"__base__/graphics/entity/oil-refinery/hr-oil-refinery.png",
			"__xander-mod-th-graphics-0__/graphics/entity/production/ore-processor-2/hr-2.png",
		},
		{
			"__base__/graphics/entity/oil-refinery/oil-refinery-fire.png",
			"__xander-mod-th-graphics-0__/graphics/entity/production/ore-processor-2/dust.png",
		},
		{
			"__base__/graphics/entity/oil-refinery/hr-oil-refinery-fire.png",
			"__xander-mod-th-graphics-0__/graphics/entity/production/ore-processor-2/hr-dust.png",
		},
	},
	{
		name = "ore-processor-2",
		icon = "__xander-mod-th__/graphics/item/production/extraction-machine/ore-processor-2.png",
		minable = {result = "ore-processor-2"},
		max_health = 400,
