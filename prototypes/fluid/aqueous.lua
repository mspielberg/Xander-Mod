...
--Distilled Water (pure H2O)
{
	...
	max_temperature = 100,
	icon = "__xander-mod-th__/graphics/fluid/aqueous/distilled-water.png",
	icon_size = 32,
...
--Nitric Acid
{
	...
	max_temperature = 100,
	icon = "__xander-mod-th__/graphics/fluid/aqueous/nitric-acid.png",
	icon_size = 32,
	pressure_to_speed_ratio = 0.4,
	flow_to_energy_ratio = 0.59,
	subgroup = "fluid",
...
--Nitric-Sulfuric Acid Mixture
{
	...
	max_temperature = 100,
	icon = "__xander-mod-th__/graphics/fluid/aqueous/nitric-sulfuric.png",
	icon_size = 32,
	pressure_to_speed_ratio = 0.4,
	flow_to_energy_ratio = 0.59,
	subgroup = "fluid",
...
--Oleum
{
	...
	max_temperature = 100,
	icon = "__xander-mod-th__/graphics/fluid/aqueous/oleum.png",
	icon_size = 32,
	pressure_to_speed_ratio = 0.4,
	flow_to_energy_ratio = 0.59,
	subgroup = "fluid",
...
--Phosphoric Acid
{
	...
	max_temperature = 100,
	icon = "__xander-mod-th__/graphics/fluid/aqueous/phosphoric-acid.png",
	icon_size = 32,
	pressure_to_speed_ratio = 0.4,
	flow_to_energy_ratio = 0.59,
	subgroup = "fluid",
...
--Gray Water - Light Waste
{
	...
	max_temperature = 100,
	icon = "__xander-mod-th__/graphics/fluid/aqueous/gray-water.png",
	icon_size = 32,
	pressure_to_speed_ratio = 0.4,
	flow_to_energy_ratio = 0.59,
	subgroup = "fluid",
...
--Waste Water - Medium Waste
{
	...
	flow_color = {r = 0.3, g = 0.3, b = 0.3},
	max_temperature = 100,
	icon = "__xander-mod-th__/graphics/fluid/aqueous/waste-water.png",
	icon_size = 32,
	pressure_to_speed_ratio = 0.4,
	flow_to_energy_ratio = 0.59,
	subgroup = "fluid",
...
--Waste Slurry - Heavy Waste
{
	...
	flow_color = {r = 0.3, g = 0.3, b = 0.3},
	max_temperature = 100,
	icon = "__xander-mod-th__/graphics/fluid/aqueous/waste-slurry.png",
	icon_size = 32,
	pressure_to_speed_ratio = 0.4,
	flow_to_energy_ratio = 0.59,
	subgroup = "fluid",
