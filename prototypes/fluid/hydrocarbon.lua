...
--Benzene
{
	...
	max_temperature = 100,
	icon = "__xander-mod-th__/graphics/fluid/hydrocarbon/benzene.png",
	icon_size = 32,
...
--Butadiene
{
	...
	max_temperature = 100,
	icon = "__xander-mod-th__/graphics/fluid/hydrocarbon/butadiene.png",
	icon_size = 32,
	pressure_to_speed_ratio = 0.4,
	flow_to_energy_ratio = 0.59,
	subgroup = "fluid-hydrocarbon",
...
--Heavy Naptha
{
	...
	max_temperature = 100,
	icon = "__xander-mod-th__/graphics/fluid/hydrocarbon/heavy-naptha.png",
	icon_size = 32,
	pressure_to_speed_ratio = 0.4,
	flow_to_energy_ratio = 0.59,
	subgroup = "fluid-hydrocarbon",
...
--Methane
{
	...
	max_temperature = 100,
	icon = "__xander-mod-th__/graphics/fluid/hydrocarbon/methane.png",
	icon_size = 32,
	pressure_to_speed_ratio = 0.4,
	flow_to_energy_ratio = 0.59,
	subgroup = "fluid-hydrocarbon",
...
--Propylene
{
	...
	max_temperature = 100,
	icon = "__xander-mod-th__/graphics/fluid/hydrocarbon/propylene.png",
	icon_size = 32,
	pressure_to_speed_ratio = 0.4,
	flow_to_energy_ratio = 0.59,
	subgroup = "fluid-hydrocarbon",
...
--Styrene
{
	...
	max_temperature = 100,
	icon = "__xander-mod-th__/graphics/fluid/hydrocarbon/styrene.png",
	icon_size = 32,
	pressure_to_speed_ratio = 0.4,
	flow_to_energy_ratio = 0.59,
	subgroup = "fluid-hydrocarbon",
