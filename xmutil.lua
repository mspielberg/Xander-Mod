...
function M.assembler_pipes(graphics_source)
  return {
    north =
    {
      filename = "__xander-mod-th-graphics-0__/graphics/entity/production/" .. graphics_source .. "/pipe-N.png",
      priority = "extra-high",
      width = 35,
      height = 18,
      ...
      hr_version =
      {
        filename = "__xander-mod-th-graphics-0__/graphics/entity/production/" .. graphics_source .. "/hr-pipe-N.png",
        priority = "extra-high",
        width = 71,
        height = 38,
    ...
    east =
    {
      filename = "__xander-mod-th-graphics-0__/graphics/entity/production/" .. graphics_source .. "/pipe-E.png",
      priority = "extra-high",
      width = 20,
      height = 38,
      ...
      hr_version =
      {
        filename = "__xander-mod-th-graphics-0__/graphics/entity/production/" .. graphics_source .. "/hr-pipe-E.png",
        priority = "extra-high",
        width = 42,
        height = 76,
    ...
    south =
    {
      filename = "__xander-mod-th-graphics-0__/graphics/entity/production/" .. graphics_source .. "/pipe-S.png",
      priority = "extra-high",
      width = 44,
      height = 31,
      ...
      hr_version =
      {
        filename = "__xander-mod-th-graphics-0__/graphics/entity/production/" .. graphics_source .. "/hr-pipe-S.png",
        priority = "extra-high",
        width = 88,
        height = 61,
    ...
    west =
    {
      filename = "__xander-mod-th-graphics-0__/graphics/entity/production/" .. graphics_source .. "/pipe-W.png",
      priority = "extra-high",
      width = 19,
      height = 37,
      ...
      hr_version =
      {
        filename = "__xander-mod-th-graphics-0__/graphics/entity/production/" .. graphics_source .. "/hr-pipe-W.png",
        priority = "extra-high",
        width = 39,
        height = 73,
...
function M.reapply_technology(name)
